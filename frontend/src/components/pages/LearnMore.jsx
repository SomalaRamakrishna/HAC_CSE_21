  ...
  return (
    <div className="learn-more-container">
      ...
      <div className="features">
        <h2>🔮 Lets go to the Power</h2>
        <div className="feature-grid">
          {[ 
            { icon: "🧠", title: "Powerful Matching", desc: "Smart recommendations for expanding your network." },
            { icon: "⚡", title: "Instant Collaboration", desc: "Share PDFs, videos, and real-time content." },
            { icon: "🌍", title: "Global Student Hub", desc: "Connect with like-minded peers of Campus." },
