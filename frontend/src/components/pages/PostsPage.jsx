     ...
     <div className="left-sidebar">
      ...
      <div className="posts-container-main">
        ...
        <div className="post-card-items highlight-main">
          <div className="post-input-section" id="highlight-main-mobile">
          ...
          <div className="post-actions" id="highlight-main-mobile">
      ...
      {/* Right Sidebar */}
        ...
        <div className="leaderboard-card special-glow">
          ...
          {rankedUsers?.slice(0, 3).map((user, index) => (
            <p className="top-list"key={index} onClick={()=>{navigate('/leaderboard')}}>
